  ...
  return (
    <>
      ...
      {open ? (
        <div className="eyeliner-info">
          <div className="eyeliner-info-inner">
            <div className="eyeliner-prices" onClick={() => pricesClick()}>
              Prices
            </div>
            <div className="eyeliner-divider">|</div>
            <div
              className="eyeliner-questions"
              onClick={() => questionsClick()}
            >
              Questions & answers
            </div>
            <div className="eyeliner-divider">|</div>
            <div className="eyeliner-care" onClick={() => careClick()}>
              {" "}
              Pre and Post Care
            </div>
          </div>
        ...
        <div className="eyeliner-info-2">
          <div className="eyeliner-info-box">
            {questions ? (
              <div className="eyeliner-q-outer-outer">
                <div className="eyeliner-q-outer">
                  <div
                    className="eyeliner-q-close"
                ...
                {priceText ? (
                  <div className="eyeliner-prices-text">
                ...
                {questionsText ? (
                  <div className="eyeliner-questions-text">
                ...
                {preText ? (
                  <div className="eyeliner-pre-text">these are the pre</div>
                ) : (
                  <div></div>
                )}
              </div>
          ...
          <div className="eyeliner-info-inner-2">
            <div className="eyeliner-prices-2" onClick={() => pricesClick()}>
              Prices
            </div>
            <div className="eyeliner-divider-2">|</div>
            <div
              className="eyeliner-questions-2"
              onClick={() => questionsClick()}
            >
              Questions & answers
            </div>
            <div className="eyeliner-divider-2">|</div>
            <div className="eyeliner-care-2" onClick={() => careClick()}>
              {" "}
              Pre and Post Care
            </div>
          </div>
